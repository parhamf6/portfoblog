...
export const BlogPosts: BlogCardProps[] = [
...

  {
    ...
    techTags: ["Python", "TypeScript", "RAG"],
    meta: {
      author: { name: "Parham Forati" },
  ...
  },
  {
    ...
    techTags: ["Network Security", "OWASP", "DNS", "Web Development", "Cybersecurity", "DevOps"],
    meta: {
      author: { name: "Parham Forati" },
  ...
  {
    id: "6",
    title: "Understanding Web Servers: My Apache Learning Journey",
    description:
    ...
    // coverImage: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=400&fit=crop&q=80',
    coverImage: "/thumbnails/understanding-web-servers-my-apache-learning-journey.png",
    techTags: ["Network Security", "OWASP","Web Server", "Web Development", "Apache", "DevOps"],
    meta: {
      author: { name: "Parham Forati" },
    ...
    slug: "understanding-web-servers-my-apache-learning-journey",
    category: "Security",
    featured: false,
    primaryTech: "network",
  },
