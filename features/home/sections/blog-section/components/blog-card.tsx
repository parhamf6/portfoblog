...
const TechTag: React.FC<TechTagProps> = ({ tech, className = "" }) => {
  const getTechStyles = (tech: string) => {
    ...
    const techConfig = {
      ...
      openai: { bg: "bg-emerald-600/20", text: "text-emerald-400", border: "border-emerald-600/30" },
      pinecone: { bg: "bg-purple-600/20", text: "text-purple-400", border: "border-purple-600/30" },
      langchain: { bg: "bg-indigo-600/20", text: "text-indigo-400", border: "border-indigo-600/30" },
      dns: { bg: "bg-orange-600/20", text: "text-orange-400", border: "border-orange-600/30" },
      networking: { bg: "bg-red-600/20", text: "text-red-400", border: "border-red-600/30" },
